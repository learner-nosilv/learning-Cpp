...
> **IN & OUT**
    `어려웠던 것`  **in과 get이 읽는 것, out과 put이 쓰는 것인게 좀 헷갈렸음**

    **프로그램** 입장에서는 파일이 프로그램으로 in 인 게 읽는 것  
  
    **프로그램** 입장에서는 파일로부터 get하는 게 읽는 것  
  
    **프로그램** 입장에서는 프로그램에서 파일로 out 인 게 쓰는 것  
  
    **프로그램** 입장에서는 프로그램에서 파일로 put 인 게 쓰는 것  
